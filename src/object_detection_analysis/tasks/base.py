...
class BaseAnalysisTask(ABC):
    def __init__(self):
        ...
        self._ctx_objdata: dict[str, ContextObjectData] = None
    ...
    def set_ctx(
            self, 
            imgs: List[str], 
            detections: dict[str, ContextDetectionBoxData], 
            masks: dict[str, ContextDetectionMaskData], 
            objdata: dict[str, ContextObjectData],
    ...
    def set_object_data(self, object_data: dict[str, ContextObjectData]):
        self._ctx_objdata = object_data
